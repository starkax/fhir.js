...
/***/ function(module, exports, __webpack_require__) {
	...
	auth = __webpack_require__(15);

	searchByPatient = __webpack_require__(17);

	searchResultsAsGraph = __webpack_require__(18);
	...
	module.exports = function(config) {
	  ...
	  return ["search", "nextPage", "prevPage", "conformance", "document", "profile", "transaction", "history", "create", "read", "update", "delete", "vread", "resolve"].reduce((function(acc, v) {
	    acc[v] = defer(v);
	    return acc;
	  }), {
